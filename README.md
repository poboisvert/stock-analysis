...
Steve base his decision mostly on historical returns and the trend (her parent's opinion). Based on the figure 1 all stocks seems to have a steady liquidity with a large volume of shares traded (100MM+). The conclusion for this year are (1) investors were able to get a higher valuation of their shares with an increase of 67% on average for the last twelve months (LTM).
